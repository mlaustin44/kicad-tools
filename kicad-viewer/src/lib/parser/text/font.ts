...
// NOTE: The Font.draw() and Font.draw_line() methods from upstream KiCanvas
// have been removed because they required KiCanvas's Renderer/Polyline from
// `src/graphics/`, which we intentionally do not vendor. Text layout
// (get_line_extents, break_lines, get_text_as_glyphs, get_markup_as_glyphs,
// get_line_positions, wordbreak_markup) is preserved; rendering can be added
// later by walking the returned glyphs.
...
export abstract class Font {
    ...
    // draw() and draw_line() removed — see header comment.
