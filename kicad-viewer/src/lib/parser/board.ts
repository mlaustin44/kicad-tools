...
/** Minimal placeholder for KiCanvas's Project. Our adapter does not set this
 *  field; it only exists to satisfy the `project?: Project` property. */
...
class GraphicItem implements HasUniqueID, HasStrokeParams {
    // `| undefined` explicit to accommodate constructor-parameter subclasses
    // whose optional parameters are typed as `T | undefined` under
    // exactOptionalPropertyTypes.
    parent?: Footprint | KicadPCB | undefined;
    layer: string;
    uuid?: string;
    tstamp?: string;
    locked = false;
...
export class Text implements HasUniqueID {
    // `| undefined` explicit to accommodate constructor-parameter subclasses
    // (FpText) whose optional parameters are typed as `T | undefined` under
    // exactOptionalPropertyTypes.
    parent?: Footprint | Dimension | KicadPCB | undefined;
    text: string;
    at: At;
